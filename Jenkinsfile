    ...
    stages {
        ...
        stage ('deploy app to browser') {
            steps {
                ...
                sh '''
                    docker run -p 91:5000 -e POSTGRES_HOST=project.cj8fxkx2ctxo.eu-west-1.rds.amazonaws.com -e POSTGRES_USER=project -e POSTGRES_PASSWORD=password123 -e POSTGRES_DATABASE_NAME=postgres -e TO_ADDRESS=ruufman@yahoo.com -e SOURCE_ADDRESS=ruufman@gmail.com -e AWS_REGION_NAME=eu-west-1 -e AWS_ACCESS_NAME=AKIAZB6KW5VE6KBBYYTU -e AWS_KEY_NAME=kOoq4ozR2jIe7bkp1pEnwEXRFowboOECzgwp/dff 02271589/proj:v1
            }
        }
    }
